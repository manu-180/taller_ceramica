...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    body: FutureBuilder<String>(
      future: ObtenerRubro().rubro(fullName), // Obtener el rubro del usuario
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return _buildLoadingScreen(size, color);
          ...
          if (rubro == "Clases de cerámica") {
            return _homeCeramica(size, color, localizations, user, firstName, fullName, themeColor, context);
          } else if (rubro == "Clases de natación") {
            return _homeNatacion(size, color, localizations, user, firstName, fullName,themeColor, context);
          } else {
            return Center(
...
Widget _buildLoadingScreen(Size size, ColorScheme color) {
  return Center(
    child: Padding(
