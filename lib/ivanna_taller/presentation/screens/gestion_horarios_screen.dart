...
class GestionHorariosScreenIvanna extends StatefulWidget {
  const GestionHorariosScreenIvanna({super.key});

  @override
  State<GestionHorariosScreenIvanna> createState() =>
      _GestionHorariosScreenIvannaState();
}

class _GestionHorariosScreenIvannaState
    extends State<GestionHorariosScreenIvanna> {
  String? taller;
